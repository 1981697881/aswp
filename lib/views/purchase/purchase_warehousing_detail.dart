...
//获取包装规格
  ...
  void _onEvent(event) async {
    ...
    if (checkItem == "position") {
      ...
      if (fBarCodeList == 1) {
        ...
        'FID,FInQtyTotal,FOutQtyTotal,FEntity_FEntryId,FRemainQty,FBarCodeQty,FStockID.FName,FStockID.FNumber,FMATERIALID.FNUMBER,FOwnerID.FNumber,FBarCode,FSN,FPackageSpec,FStockID.FIsOpenLocation';
        Map<String, dynamic> dataMap = Map();
              ...
              if (scanCode[5] == "N") {
                if (element[0]['value']['scanCode'].indexOf(code) == -1) {
                  ...
                  if (element[4]['value']['value'] == "") {
                    ...
                    element[4]['value']['value'] = this.storehouseNumber == null
                        ? ""
      ...
      if (number == 0 && this.fBillNo == "") {
        materialDate.forEach((value) {
          ...
          arr.add({
            ...
            "isHide": false,
            "value": {
              "label": this.storehouseName == null ? "" : this.storehouseName,
              "value":
                  this.storehouseNumber == null ? "" : this.storehouseNumber,
            }
          });
          arr.add({
            "title": "批号",
          ...
          arr.add({
            ...
            "isHide": false,
            "value": {
              "label": this.storingLocationName == null
                  ? ""
                  : this.storingLocationName,
              "value": this.storingLocationNumber == null
                  ? ""
                  : this.storingLocationNumber,
              "hide": showPosition
            }
  ...
  void _onDateChildClickItem(model, hobby) {
    Pickers.showDatePicker(
      ...
      maxDate: PDuration(second: 22),
      selectDate:
          (hobby['value']['label'] == '' || hobby['value']['label'] == null
      ...
      onConfirm: (p) {
        ...
        setState(() {
          hobby['value']['label'] = formatDate(
              DateFormat('yyyy-MM-dd').parse('${p.year}-${p.month}-${p.day}'), [
            yyyy,
            "-",
            mm,
            "-",
                                    ...
                                    for (var value in orderDate) {
                                      ...
                                      if (childItemNumber == i) {
                                        ...
                                        arr.add({
                                          ...
                                          "isHide": false,
                                          "value": {
                                            "label": this.storehouseName == null
                                                ? ""
                                                : this.storehouseName,
                                            "value":
                                                this.storehouseNumber == null
                            ...
                            if (checkItem == "HPoc") {
                              ...
                              if (this.hobby[checkData][checkDataChild]
                                ...
                                if (positionList.length > 1) {
                                  ...
                                  //输入数量除于包装规格，等于基础分录个数
                                  var lineSplit = (double.parse(
                                              this.hobby[checkData][3]["value"]
                                                  ["label"]) /
                                          double.parse(this
                                              .hobby[checkData][1]["value"]
                                                  ["label"]
                                              .toString()
                                              .replaceAll('kg', '')))
                                      .ceil();
                                  if (this.hobby[checkData][1]["value"]
                                              ["label"] !=
                                          "" &&
                                      this.hobby[checkData][3]["value"]
                                              ["label"] !=
                                          "") {
                                    if (double.parse(this.hobby[checkData][3]
                                                ["value"]["label"]) >
                                            double.parse(this
                                                .hobby[checkData][1]["value"]
                                                    ["label"]
                                                .toString()
                                                .replaceAll('kg', '')) &&
                                        double.parse(this.hobby[checkData][3]
                                                ["value"]["label"]) >
                                            positionList.length) {
                                      //判断以那个条件做拆分
                                      var splitNum = 0;
                                      ...
                                      //包装规格转换为数值，以便计算
                                      var packaging = double.parse(this
                                          .hobby[checkData][1]["value"]["label"]
                                          .toString()
                                          .replaceAll('kg', ''));
                                      //计算每个分录分配数量 默认为包装规格数量(前置条件为：入库数量必须大于包装规格)
                                      var itemNum = double.parse(this
                                          .hobby[checkData][1]["value"]["label"]
                                          .toString()
                                          .replaceAll('kg', ''));
                                      //输入的入库数量
                                      var inventoryQuantity = double.parse(
                                          this.hobby[checkData][3]["value"]
                                              ["label"]);

                                      this.hobby[checkData][3]["value"]
                                          ["label"] = packaging.toString();
                                      this.hobby[checkData][3]["value"]
                                          ["value"] = packaging.toString();
                                      this.hobby[checkData][9]["value"]
                                              ['label'] =
                                          double.parse(this.hobby[checkData][3]
                                              ["value"]["value"]);
                                      ...
                                      this.hobby[checkData][9]["value"]
                                          ...
                                          double.parse(this.hobby[checkData][3]
                                              ["value"]["value"]);
                                      this.hobby[checkData][checkDataChild]
                                          ["value"]["label"] = positionList[0];
                                      this.hobby[checkData][checkDataChild]
                                          ['value']["value"] = positionList[0];
                                      for (var i = 1; i < splitNum; i++) {
                                        var orderDataItem =
                                            List.from(this.orderDate);
                                        this.orderDate.insert(checkData,
                                            orderDataItem[checkData]);
                                        this.fNumber = [];
                                        var childItemNumber = 0;
                                        for (var value in orderDate) {
                                          fNumber.add(value[5]);
                                          ...
                                          if (childItemNumber == checkData) {
                                            ...
                                            arr.add({
                                              ...
                                              "isHide": false,
                                              "name":
                                                  "FMaterialIdFSpecification",
                                              "value": {
                                                "label": this.hobby[checkData]
                                                    [1]["value"]["label"],
                                                "value": this.hobby[checkData]
                                                    [1]["value"]["value"]
                                              }
                                              //"value": {"label": value[25]==null?"":value[25], "value": value[25]==null?"":value[25]}
                                            });
                                            ...
                                            arr.add({
                                              ...
                                              "isHide": false,
                                              "value": {
                                                "label": positionList[i],
                                                "value": positionList[i],
                                                "hide": true
                                              }
                                            });
                                            arr.add({
                                      ...
                                      ToastUtil.showInfo(
                                          '输入数量必须大于库位个数和包装规格，否则不允许拆分');
                                    }
                                  } else {
                                    ToastUtil.showInfo(
                                        '入库数量和包装规格需提前录入,否则无法拆分行');
                                    Navigator.pop(context);
                                  }
                                } else {
                                  Navigator.pop(context);
  ...
  //递归 数量轮询
  insertItemNum(
      checkData, itemNum, splitNum, packaging, inventoryQuantity) async {
    for (var i = checkData + splitNum - 1; i >= checkData; i--) {
      if (inventoryQuantity - itemNum > 0) {
        this.hobby[i][3]["value"]["label"] =
            ((double.parse(this.hobby[i][3]["value"]["value"]) * 100 +
                        (inventoryQuantity - itemNum > packaging
                                ? packaging
                                : inventoryQuantity - itemNum) *
                            100) /
                    100)
                .toString();
        this.hobby[i][3]["value"]["value"] = this.hobby[i][3]["value"]["label"];
        this.hobby[i][9]["value"]['label'] =
            double.parse(this.hobby[i][3]["value"]["value"]);
        this.hobby[i][9]["value"]['value'] =
            double.parse(this.hobby[i][3]["value"]["value"]);
        this.hobby[i][9]["value"]['rateValue'] =
            double.parse(this.hobby[i][3]["value"]["value"]);
      ...
      if (inventoryQuantity - itemNum > packaging) {
        ...
        itemNum =
            (itemNum * 100 + inventoryQuantity * 100 - itemNum * 100) / 100;
      }
    }
    if (inventoryQuantity - itemNum > 0) {
      this.insertItemNum(
          checkData, itemNum, splitNum, packaging, inventoryQuantity);
    }
  }
      ...
      for (int entity = 0; entity < resData.length; entity++) {
        for (int element = 0; element < this.hobby.length; element++) {
          if (resData[entity][1].toString() ==
            ...
            if(this.hobby[element][5]['value']['value'] != '' && this.hobby[element][5]['value']['value'] != null){
              FEntityItem['FLot'] = {"FNumber": this.hobby[element][5]['value']['value']};
            }
      ...
      if (type) {
        ...
        for (var element in this.hobby) {
          if (element[3]['value']['value'] != '0' &&
            ...
            FEntityItem['FBaseUnitID'] = {"FNumber": element[0]['FBaseUnitID']};
            ...
            FEntityItem['FInStockEntry_Link'] = [
              {
                ...
                "FInStockEntry_Link_FRemainInStockBaseQty": element[3]['value']
                    ['value']
              }
            ];
            FEntity.add(FEntityItem);
        ...
        // FinanceEntity['FPayConditionId'] = {
        //   "FNumber": this.hobby[0][0]['FPayConditionId']
        // };
        ...
        if (res['Result']['ResponseStatus']['IsSuccess']) {
          ...
          for (var p = 0;
              ...
              p++) {
            printData['data']['Model']['FInStockEntry'][p]['FExpiryDate'] =
                returnData[0]['FInStockEntry'][p]['FExpiryDate'];
            printData['data']['Model']['FInStockEntry'][p]['FProduceDate'] =
                returnData[0]['FInStockEntry'][p]['FProduceDate'];
            printData['data']['Model']['FInStockEntry'][p]['FMaterialName'] =
                returnData[0]['FInStockEntry'][p]['FMaterialName'];
          }
          ...
          var entryList = returnData[0]['FInStockEntry'];
          print(entryList);
          var subEntryList = [];
          for(var entry in entryList){
            subEntryList.add(entry['FEntryID']);
          }
          //修改批号
          Map<String, dynamic> releaseDataMap = Map();
          var releaseNumbers = [];
          releaseDataMap['formid'] = 'STK_InStock';
          releaseDataMap['opNumber'] = 'GenerateLotByCodeRule';
          Map<String, dynamic> releaseEntityMap = Map();
          releaseEntityMap['Id'] = returnData[0]['FBillNo'];;
          releaseEntityMap['EntryIds'] = subEntryList;
          ...
          if (releaseRes['Result']['ResponseStatus']['IsSuccess']) {
            ...
            setState(() {
              ...
              ToastUtil.errorDialog(context,
                  releaseRes['Result']['ResponseStatus']['Errors'][0]['Message']);
            });
          }
                  ...
                  Visibility(
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        child: ListTile(
                            title: Text(
                                '入库仓位：' + this.storingLocationName.toString()),
                            trailing: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: <Widget>[
                                  IconButton(
