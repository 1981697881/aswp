...
class _ExWarehouseDetailState extends State<ExWarehouseDetail> {
  ...
  getOrderList() async {
    ...
    userMap['FieldKeys'] =
    'FBillNo,FStockOrgId.FNumber,FStockOrgId.FName,FDate,FEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FCustId.FNumber,FCustId.FName,FUnitId.FNumber,FUnitId.FName,FQty,FNote,FID,FAuxPropId,FMaterialId.FIsBatchManage,FStockID.FIsOpenLocation,FTotalSecQty,FMaterialId.FIsKFPeriod,FDeptId.FName,FDeptId.FNumber';
    Map<String, dynamic> dataMap = Map();
    dataMap['data'] = userMap;
  ...
  saveOrder() async {
    if (this.hobby.length > 0) {
      if (this._remarkContent.text == "" || this._remarkContent.text == null) {
        this.isSubmit = false;
        ToastUtil.showInfo('请输入备注');
        return;
      }
      setState(() {
        this.isSubmit = true;
